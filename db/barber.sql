...
--
-- Hôte : localhost:3306
-- Généré le : lun. 16 mai 2022 à 11:42
...
(44, 'Baume \"Tech Art\" Fix Design L\'Oréal', 'Lorsqu’on les laisse au naturel, les poils de barbe peuvent partir dans tous les sens et finir par s’emmêler. Les discipliner est une mission contraignante mais indispensable pour obtenir un look impeccable.', 'coiffant.jpg', 12, 0),
(45, 'Baume \"Golden Beards\" HEARD BALM', 'Golden Beards baume organique barbe est la même formule que notre succès merveilleuse huile Toscana, mais dans une version de baume. Il maintient et maintient votre peau et la barbe hydratée et stimule la croissance de votre barbe. ', 'coiffant1.png', 12, 0),
(46, 'Baume \"Poraso\" Baume pour la barbe', 'Baume pour la barbe créé pour réduire les désagréments au début de la pousse de barbe. Il permettra de nourrir en profondeur les poils de barbe et à les rendre plus souples.', 'coiffant2.png', 12, 0),
(53, 'Shampoing \"The Barber Company\" 250 ml', 'Comme son nom l’indique, ce shampooing à l’essence de vétiver et aux notes orientales boisées peut être utilisé quotidiennement. À chaque fois que vous l’appliquerez, une sensation de fraîcheur vous envahira. Le résultat sur votre cuir chevelu ? Un équilibre maintenu et une pousse plus belle.', 'shampoing.jpg', 11, 0),
(54, 'Shampoing \"Osma Tradition\" 200 ml', 'Shampoing au miel pour cheveux secs à très secs de la marque française Osma Tradition\r\nBouteille en plastique avec bouchon à vis, 200ml.\r\nBouton \"press\" pratique pour doser.\r\nParfum léger et doux de miel', 'shampoing1.png', 11, 0),
(55, 'Shampoing XS GREY 100 ml', 'Shampoing Grey de la marque espagnole Beardburys.\r\nSpécialement conçu pour les cheveux blancs et gris.\r\nContient des pigments pour neutraliser les reflets jaunes. \r\nBouteille en plastique de 100 ml avec bouchon à vis.\r\nSans parabens.', 'shampoing2.png', 11, 0),
(56, 'Huile a Barbe Keune Satin 95 ml', 'L\'huile Satin oil, enrichie d\'huile de maracuja, de baobab et de monoï, est un véritable phénomène cosmétique qui améliore la qualité de la barbe de manière spectaculaire. Elle fortifie et donne de la brillance sans rendre la barbe grasse ou l\'alourdir.', 'huile.png', 9, 0),
(57, 'Huile a Barbe AZBANE Beard Oil 30 ML', 'Huile d\'entretien de la barbe \"Geranium & Citrus\" fabriquée au Maroc par Azbane.\r\nFlacon en verre avec bouchon pipette, 30ml.', 'huile2.png', 9, 0),
(58, ' Cire Cheveux/Barbe \"Le père Lucien\" 15g', 'Cire à moustache Le Père Lucien Traditionnel formulée à partir de 100% d\'ingrédients naturels.\r\nElle permet de mettre en forme et fixer les poils de votre moustache et de les nourrir en profondeur.\r\nCette cire à moustache Le Père Lucien Traditionnel en format 15g apporte une fixation forte sans effet “collé”.', 'cire1.png', 10, 0),
(59, 'Moustache WAX  \"Dr.K\'s 100% \" 15g', 'Fabriqué en utilisant uniquement des ingrédients 100% naturels et «végétaliens», cette cire efficacement moustache contient abeilles et CARNAUBA pour mieux sculpter votre style tandis que la vitamine E apaise et revitalise la peau et une moustache.', 'cire2.png', 10, 0);
...
INSERT INTO `users` (`Id_user`, `Password`, `Mail`, `Id_status`) VALUES
(1, 'root', 'enola.tutellier@hotmail.com', 1);
...
--
ALTER TABLE `articles`
  MODIFY `Id_article` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
